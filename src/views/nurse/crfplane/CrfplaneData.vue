...
export default class CrfplaneData extends Vue {
  /**
   * 表格数据
   */
  ...
  public onEditCrf() {
      ...
      this.$router.push({name: 'crfplanedata_edit', query: {id: this.selectedRow.visitId}});
  }
  /**
   * 获取数据列表
   */
  ...
  private onRowDblclick() {
    ...
    this.$router.push({name: 'crfplanedata_edit', query: {id: this.selectedRow.visitId, isDisabled: '1'}});
  }
}
</script>
